...
public class ChatBotAdmin {
    ...
    public String tradeStopBySeller(ChatRoom chatRoom, Member seller, Member buyer) {
        int step = chatRoom.getInteractStep();

        switch (step) {
            case 1 : // case1 거래하기 전
            case 2 :
                String messageCase1_seller = String.format("거래 중지 완료되었습니다.\n" +
                ...
                SellerChat sellerChatCase1 = SellerChat.buildSellerChat(messageCase1_seller, TRADE_STOP_REQUEST_SELLER , chatRoom);
                BuyerChat buyerChatCase1 = BuyerChat.buildBuyerChat(messageCase1_buyer, TRADE_STOP_REQUEST_BUYER, chatRoom);
                ...
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(seller.getId(), messageCase1_seller));
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(buyer.getId(), messageCase1_buyer));
                break;
            case 3 : // case2 입금이 확인된 상태 or case3
                ...
                SellerChat sellerChatCase2 = SellerChat.buildSellerChat(messageCase2_seller, TRADE_STOP_REQUEST_SELLER , chatRoom);
                BuyerChat buyerChatCase2 = BuyerChat.buildBuyerChat(messageCase2_buyer, TRADE_STOP_REQUEST_BUYER, chatRoom);
                ...
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(seller.getId(), messageCase2_seller));
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(buyer.getId(), messageCase2_buyer));
    ...
    public void tradeStopByBuyer(ChatRoom chatRoom, Member seller, Member buyer) {
        ...
        switch (step) {
            ...
            case 2 :
                ...
                String messageCase1_buyer = String.format("거래 중지 완료되었습니다.\n" +
            ...
            case 3 : // case2 입금이 확인된 상태 or case3
                ...
                String messageCase2_buyer = String.format("판매자에게 거래 중지 요청을 보냈습니다. 송금한 금액은 거래 중지일 기준 2~3일 후에 구매자님의 계좌로 환불됩니다.\n" +
            ...
            case 4 : // 서적 배치 완료
                ...
                String messageCase3_buyer = String.format("판매자에게 거래 중지 요청을 보냈습니다. 송금한 금액은 거래 중지일 기준 2~3일 후에 구매자님의 계좌로 환불됩니다.\n" +
                        "아래 환불 정책에 따라 환불금액을 확인해주세요!\n" +
                        "\n" +
                        "서적배치전: 100%% 환불\n" +
                        "서적배치후: 70%% 환불\n");

                SellerChat sellerChatCase3 = SellerChat.buildSellerChat(messageCase3_seller, TRADE_STOP_REQUEST_SELLER, chatRoom);
                BuyerChat buyerChatCase3 = BuyerChat.buildBuyerChat(messageCase3_buyer, TRADE_STOP_REQUEST_BUYER , chatRoom);
                ...
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(seller.getId(), messageCase3_seller));
                fcmService.sendChattingNotificationByToken(FcmTargetUserIdRequest.of(buyer.getId(), messageCase3_buyer));
