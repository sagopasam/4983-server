...
public class MyPageBookPurchaseDetailListController {
    ...
    @GetMapping
    public ResponseEntity<List<MyPageBookPurchaseDetailListResponse>> getMyPageBookPurchaseDetailList(@RequestParam BookStatus bookStatus, AccessToken accessToken) {
